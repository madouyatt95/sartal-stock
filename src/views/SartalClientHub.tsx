...
import {
  ArrowRight, BedDouble, CalendarCheck, Gift, HeartHandshake,
  History, KeyRound, Languages, LockKeyhole, MessageCircle, QrCode,
  ReceiptText, ShieldCheck, ShoppingBag, Sparkles, Star, TicketCheck,
  Truck, UserRound, UtensilsCrossed, WalletCards
} from 'lucide-react';
...
export const SartalClientHub: React.FC<SartalClientHubProps> = ({ state, customerId, onOpenRestaurant, onOpenDelivery, onMessage }) => {
  const { db, updateSartalCustomerProfile, createSartalClientAccess, requestSartalService, redeemSartalPoints, reorderDeliveryOrder } = state;
